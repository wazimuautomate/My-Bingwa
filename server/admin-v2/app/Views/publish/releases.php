...
<div class="card">
  <div class="table-wrap">
    <table class="data">
      <thead><tr><th>Version</th><th>Published</th><th>By</th><th>Type</th><th>Signed</th><th>Checksum</th><th>Notes</th><th></th></tr></thead>
      <tbody>
        <?php foreach ($releases as $r): ?>
          <tr>
            ...
            <td><?= ($r['signature'] ?? '') ? '<span class="status active">Signed</span>' : '<span class="status draft">Checksum</span>' ?></td>
            <td class="mono small"><?= e(substr((string) $r['checksum'], 0, 12)) ?>…</td>
        ...
        <?php endforeach; ?>
        <?php if (!$releases): ?>
          <tr><td colspan="8"><div class="empty"><?= icon('publish', 32) ?><h3>No releases yet</h3><p>Publish your first configuration from Review &amp; publish.</p></div></td></tr>
        <?php endif; ?>
      </tbody>
    </table>
  </div>
