...
|---|---|---|
| `My-Bingwa-v1.0.9-play.aab` | **Google Play bundle** | Play Console → upload this |
| `My-Bingwa-v1.0.9-play.aab.sha256` | Checksum (computed locally after download) | Verify before uploading |
| `My-Bingwa-v1.0.9-direct.apk` | Signed APK for direct/sideload distribution | GitHub Release / direct download. **Not** for Play |
| `My-Bingwa-v1.0.9-direct.apk.sha256` | Checksum (from CI) | Verify before distributing |

File names keep the `My-Bingwa-` prefix so they match every earlier release pack and
...
- `My-Bingwa-v1.0.9-direct.apk.sha256` verified against the downloaded APK (`OK`).
