...
`versionCode`). Everything shipped in v1.0.7 — see `release/My-Bingwa-v1.0.7/README.md`
...
|---|---|---|
| `My-Bingwa-v1.0.8-play.aab` | **Google Play bundle** | Play Console → upload this |
| `My-Bingwa-v1.0.8-play.aab.sha256` | Checksum (computed locally after download) | Verify before uploading |
| `My-Bingwa-v1.0.8-direct.apk` | Signed APK for direct/sideload distribution | GitHub Release / direct download. **Not** for Play |
| `My-Bingwa-v1.0.8-direct.apk.sha256` | Checksum (from CI) | Verify before distributing |
