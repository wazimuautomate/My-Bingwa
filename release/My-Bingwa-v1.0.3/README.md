# My Bingwa v1.0.3 — production release pack
...
|---|---|---|
| `My-Bingwa-v1.0.3-play.aab` | **Google Play bundle** | Play Console → Production → Create release → upload this |
| `My-Bingwa-v1.0.3-play.aab.sha256` | Checksum for the bundle | Verify before uploading |
| `My-Bingwa-v1.0.3-direct.apk` | Signed APK for direct/sideload distribution | GitHub Release / direct download. **Not** for Play |
| `My-Bingwa-v1.0.3-direct.apk.sha256` | Checksum for the direct APK | Verify before distributing |
| `My-Bingwa-v1.0.3-debug.apk` | Debug build (`com.bingwasokoni.debug`, "My Bingwa Dev") | Test phones only — installs alongside the real app |
| `My-Bingwa-v1.0.3-debug.apk.sha256` | Checksum for the debug APK | — |
