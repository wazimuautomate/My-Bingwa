...
- Onboarding order is now **Welcome → What you gain → Name & number → Notifications →
  ...
  alternative offered is **Close My Bingwa**.
...
5. **Onboarding.** Fresh install: name and number come first, then notifications, then
   ...
   becomes "Open settings and allow"; confirm "Close My Bingwa" closes it.
...
are unchanged from `release/My-Bingwa-v1.0.3/README.md` — re-use that section verbatim.
