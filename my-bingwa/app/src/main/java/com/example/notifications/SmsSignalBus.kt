 ...
 * burst of messages is not dropped, and no replay so a late collector does not
 * re-process an old signal.
 *
 * Only classified signals (category + raw body) travel here — never raw sender
 * numbers. Nothing is logged (CLAUDE.md §10).
 */
object SmsSignalBus {
