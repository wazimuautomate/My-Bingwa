...
/**
 * Downloads a published, signed My Bingwa APK and hands it to the system package
...
class AppUpdateInstaller(context: Context) {
     ...
     * (`.../files/updates/mybingwa-<versionCode>.apk`), reporting progress as a
    ...
    suspend fun download(
        ...
        val outFile = File(updatesDir(), "mybingwa-$versionCode.apk")
        try {
